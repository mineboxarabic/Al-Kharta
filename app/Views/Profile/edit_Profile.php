                        ...
                        <div class="d-flex align-items-start mt-3 mt-sm-0">
                            <div class="flex-shrink-0">
                                <div class="avatar-xl me-3">
                                    <img src="<?php
                                        $img = $user['avatar'];
                                        //if img exists online then use it else use the default img
                                        if(strpos($img, 'http') !== false){
                                            echo $img;
                                        }
                                        else{
                                            echo base_url('Profiles/Images/'.$img);
                                        }

                                      ?>" alt="" id="profile_pic" class="img-fluid rounded-circle d-block">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div>
                                    <h5 class="font-size-16 mb-1" id="user_name"><?= $user['username'] ?>
                                    </h5>
                                    <?php if($user['role'] == 0): ?>
                                    <p id="role" class="text-muted font-size-13"><?php 
                                            if($user['role'] == 0){
                                                echo 'user';
                                            }
                                            else if($user['role'] == 1){
                                    ...
                                    <?php else: ?>
                                        ...
                                        <select class="form-select" id="role_select" aria-label="Default select example">
                                            ...
                                            <option value="2" <?php if($user['role'] == 2) echo 'selected'; ?>>Writer</option>
                                            <option value="3" <?php if($user['role'] == 3) echo 'selected'; ?>>Moderator</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl">
                                        <div class="text-muted">
                                            <p id="bio" class="mb-2"><?= $profile['Bio'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
   ...
   class EditableText
    {
            ...
            constructor(element, isTextArea = false) {
    ...
    new EditableText(username);
        let bio = document.querySelector('#bio');
        new EditableText(bio, true);

        let profilePic = document.querySelector('#profile_pic');
        new ClickAbleImage(profilePic);


        $('#form').on('submit', function(e){
            e.preventDefault();
            let form = $(this);
            let url = "<?= base_url('UserController/save_Profile') ?>";
