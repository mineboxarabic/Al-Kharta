    ...
    function layoutSetting() {
        ...
        $("input[name='layout-direction']").on('change', function () {
            ...
            if($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', URI + 'assets/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', URI + 'assets/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', URI + 'assets/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', URI + 'assets/css/app-rtl.min.css');
